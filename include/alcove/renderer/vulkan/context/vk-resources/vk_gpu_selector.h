...
public:
  ...
  VkPhysicalDeviceSelector& set_increase_rate(int rate) {
    EXTRA_WEIGHT = rate;
  }

  VkPhysicalDeviceSelector& query_physical_device_type(
  ...
  VkPhysicalDeviceSelector& query_device_extensions(
  ...
  VkPhysicalDeviceSelector& query_features(
  ...
  VkPhysicalDeviceSelector& query_features_1_1(
  ...
  VkPhysicalDeviceSelector& query_features_1_2(
  ...
  VkPhysicalDeviceSelector& query_features_1_3(
  ...
  VkPhysicalDeviceSelector& query_graphics_queue_family(Args... args) {
  ...
  VkPhysicalDeviceSelector& query_present_queue_family(VkSurfaceKHR _surface) {
  ...
  VkPhysicalDeviceSelector& select_GPU(VkInstance _instance) {
#ifndef NDEBUG
...
private:
  ...
  uint32_t get_graphics_queue_family_index(VkPhysicalDevice gpu) {
    if (!_check_graphics_queue_family_support) return true;
    ...
    // pairs of the number of flag matches and the index of the queue family
    std::multimap<int, uint32_t, std::greater<int>> queue_family_candidates;
  ...
  uint32_t get_present_queue_family_index(VkPhysicalDevice gpu) {
    if (!_check_present_queue_family_support) return true;
    ...
    // pairs of the number of flag matches and the index of the queue family
    std::set<uint32_t> queue_family_candidates;
